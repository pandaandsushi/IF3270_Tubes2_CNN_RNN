...
os.makedirs("src/rnn/experiments", exist_ok=True)
...
model.save_model_weights('src/rnn/experiments/keras_weights_rnn.weights.h5')
...
plt.tight_layout()
plot_path = "src/rnn/experiments/rnn_plot.png"
